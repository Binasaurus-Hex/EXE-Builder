...
main :: proc(){
    ...
    eb.begin(&a)
        ...
        loop_exit := eb.make_label(&a)
            ...
            // DrawCircleV({200, 100}, 20, rl.RED)
            eb.w(&a, eb.mov_r64_imm64(.RCX, transmute(u64)[2]f32{ 200, 100 }))
            eb.w(&a, eb.mov_rm64_imm32(eb.rm_reg(.RAX), transmute(u32)f32(20)))
            eb.w(&a, eb.movq_xmm_rm64(eb.XMM(1), eb.rm_reg(.RAX)))
